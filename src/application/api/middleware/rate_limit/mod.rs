...
use crate::application::config::app_config::RateLimitConfig;
...
impl Default for RateLimit {
    fn default() -> Self {
        Self {
            max_requests: RateLimitConfig::default().max_requests,
            window_seconds: RateLimitConfig::default().window_size,
        }
    }
}
