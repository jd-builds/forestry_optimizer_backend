...
use crate::{
    infrastructure::database::schema::public::{
        refresh_tokens, password_reset_tokens, email_verification_tokens, users
    },
    common::error::{Result, ApiError, ErrorCode, ErrorContext}
};
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize, ToSchema, diesel_derive_enum::DbEnum)]
#[ExistingTypePath = "crate::infrastructure::database::schema::public::sql_types::UserRole"]
pub enum Role {
    Operator,
    Manager,
    Admin,
